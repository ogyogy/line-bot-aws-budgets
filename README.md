# line-bot-aws-budgets

This is a sample template for line-bot-aws-budgets - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name line-bot-aws-budgets \
...
```bash
sam logs -n HelloWorldFunction --stack-name line-bot-aws-budgets --tail
```
...
```bash
aws cloudformation delete-stack --stack-name line-bot-aws-budgets
```
